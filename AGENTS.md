...
- Record mod decisions in `docs/mods/` (considered, chosen, held, or dropped; rationale; packwiz `side`); document only configs that need pack notes. `docs/mods/deferred.md` is the not-yet-ported list from the 1.20.1 pack, not an install queue.
