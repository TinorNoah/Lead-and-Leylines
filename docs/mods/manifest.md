...
| JEI / REI / EMI WorldGen | `jeiworldgen-neoforge-1.21.1-1.4.5.jar` | CurseForge 1509527 / 8897773 | both | recipes | Worldgen pages in JEI. Server side sends the data the client displays. | JEI (client) | defaults | 2026-09-23 |
