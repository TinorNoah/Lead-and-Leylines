...
| Alex's Caves Continued | — | — | Removed 2026-09-26 (Delight + Spellbooks with it). Codxlib stays for Alex's Mobs Continued. |
...
| Quark (+ Zeta) | — | — | Removed 2026-09-26 with Integrated BOMD / Mowzie / API / Patches. |
| Iron's Spells 'n Spellbooks | `irons_spellbooks-1.21.1-3.16.3.jar` | both | Spellbooks beside Ars Nouveau. World data. Iron's Lib. Addons: Twilight Forest, Create, Aeronautics teleports, Farmer's Delight, Epic Fight animations, Apotheosis gear. Ace's Spell Utils and AzureLib (Twilight spellbooks loads AzureLib even though its metadata does not list it). |
...
| Alex's Caves / Create compat | Dropped | Parent Alex's Caves Continued removed 2026-09-26. |
