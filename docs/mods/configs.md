...
| Bye?Pregen! | Defaults | Do not re-add Noisium or AntiXRay. Fast Noise did not raise Tectonic CPS; do not add it for that. Do not stack Fast Noise with RTF. Chunk Pregenerator stays for operator pregen. |
