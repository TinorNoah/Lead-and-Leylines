...
Crash isolation, leak patches, and network fixes.
...
|---|---|---|---|---|
| AllTheLeaks (Memory Leak Fix) | `alltheleaks-1.1.13+1.21.1-neoforge.jar` | both | `core`, `stability` | Patches known memory leaks. |
| MemGuard | `memguard-1.0.4.jar` | both | `core`, `stability` | Logs heap use. Complements AllTheLeaks. |
| Neruina - Ticking Entity Fixer | `neruina-3.3.3+1.21.1-neoforge.jar` | both | `core`, `stability` | Isolates a ticking entity instead of crashing. |
