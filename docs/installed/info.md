...
JEI, Jade, and tooltip frames. Apotheosis only shortens its own affix lines; that addon is in [Magic](magic.md).
...
| Mod | File | Side | Tags | What it adds |
|---|---|---|---|---|
| Patchouli | `Patchouli-1.21.1-93-NEOFORGE.jar` | both | `core`, `info` | In-game guide books. |
